...
const en = {
    ...
    bots: {
        ...
        validation: {
            ...
            chatNameAndIdRequired: "Enter chat name and Chat ID",
        },
        created: "Bot added",
    },
    history: {
        ...
        ports: {
            title: "Ports",
            scan: "Scan",
            scanKnown: "Scan known ports",
            scanning: "Scanning...",
            loading: "Loading ports...",
            empty: "No open known ports yet. Run a scan.",
            custom: {
                title: "Custom port",
                placeholder: "Port",
                scan: "Scan custom",
                scanning: "Scanning...",
                pending: "Scanning port {port}...",
                invalid: "Enter valid port (1..65535)",
                noDevice: "Device is not selected. Reopen dialog and try again.",
                badge: "custom",
                delete: "Delete",
                deleted: "Custom port {port} deleted",
                done: "Port {port} scanned",
                result: "Port {port}: {status}",
                openHint: "Open port is shown in the table below.",
                closedHint: "Closed port is shown in the table below.",
            },
            table: {
                service: "Service",
                port: "Port",
...
const uk = {
    ...
    bots: {
        ...
        validation: {
            ...
            chatNameAndIdRequired: "Вкажіть назву чату і Chat ID",
        },
        created: "Бота додано",
    },
    history: {
        ...
        ports: {
            title: "Порти",
            scan: "Сканувати",
            scanKnown: "Сканувати відомі порти",
            scanning: "Сканування...",
            loading: "Завантаження портів...",
            empty: "Відкритих відомих портів ще немає. Запустіть сканування.",
            custom: {
                title: "Кастомний порт",
                placeholder: "Порт",
                scan: "Сканувати кастом",
                scanning: "Сканування...",
                pending: "Скануємо порт {port}...",
                invalid: "Вкажіть коректний порт (1..65535)",
                noDevice: "Пристрій не вибрано. Закрийте і відкрийте діалог знову.",
                badge: "кастом",
                delete: "Видалити",
                deleted: "Кастомний порт {port} видалено",
                done: "Порт {port} проскановано",
                result: "Порт {port}: {status}",
                openHint: "Відкритий порт з’явиться в таблиці нижче.",
                closedHint: "Закритий порт також показується в таблиці нижче.",
            },
            table: {
                service: "Сервіс",
                port: "Порт",
